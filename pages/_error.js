        ...
        >
          ...
          <Grid container item xs={12} justify="center">
            <Typography component="h5" variant="body1" display="block" color="textPrimary">
              Something with your query goes wrong. Clarify the criteria and <Link href={`/`} color="textPrimary"
                                                                                   underline="hover">try another
              one</Link>.
            </Typography>
          </Grid>
          <Grid container item xs={12} justify="center">
            <Typography component="h5" variant="body1" display="block" color="textPrimary">
              Or <Link href={`https://github.com/AlexZeDim/conglomerat-FRONT/issues`} color="textPrimary"
                       underline="hover" prefetch={false}>submit a bug via @GitHub</Link> or <Link href={`/help`}
                                                                                                   color="textPrimary"
                                                                                                   underline="hover">any
              other contacts</Link>.
            </Typography>
