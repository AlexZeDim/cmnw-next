    ...
    return (
        <main>
            <Head>
                ...
                <meta name="description" content="CONTRACTS — historical pricing data management system for latest expansion COMMDTY items"/>
                ...
                <meta property="og:description" content="CONTRACTS — historical pricing data management system for latest expansion COMMDTY items"/>

                <meta property="twitter:card" content="summary_large_image"/>
                <meta property="og:url" content="https://conglomerat.group/"/>
                <meta property="twitter:title" content={`CONTRACT ${query.tenor.toUpperCase()}: ${title}`}/>
                <meta property="twitter:description" content="CONTRACTS — historical pricing data management system for latest expansion COMMDTY items"/>
            </Head>
